...
import { getCategoryItemGroup } from "@/lib/category-items";
...
export async function generateMetadata({
  ...
  const description = categoryGroup?.description ?? `Browse ${data.meta.total} ${categoryName.toLowerCase()} business${data.meta.total === 1 ? "" : "es"} on Nearu, including local listings, contact details, ratings, and nearby services.`;
