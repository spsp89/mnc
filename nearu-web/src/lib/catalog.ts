...
const retiredCategorySlugs = ["restaurant", "clinic", "bakery", "mobile", "doctor-booking"] as const;
...
const seedBusinesses: SeedBusiness[] = [
  ...
  },
  {
    ...
    isVerified: true,
    tags: ["bakery-sweets", "bakery", "cakes", "snacks"],
    isFeatured: true,
    isPopular: false,
  },
  {
  ...
  },
  {
    ...
    city: "Kozhikode",
    addressLine: "Nadakkavu, Calicut",
    landmark: "Near clinic row",
    latitude: 11.2712,
    longitude: 75.8376,
    phone: "+91 98765 43014",
    whatsapp: "+91 98765 43014",
    email: "care@carepluspharmacy.example",
    website: null,
    rating: 4.4,
    reviewCount: 118,
    distanceKm: 4.2,
  ...
  },
  {
    ...
    description: "School stationery, greeting cards, and small gift bundles.",
    categorySlug: "gifts-stationery",
    area: "Mananchira",
    city: "Kozhikode",
    addressLine: "Mananchira, Calicut",
    landmark: "Near library road",
    latitude: 11.2521,
    longitude: 75.7801,
    phone: "+91 98765 43015",
    whatsapp: "+91 98765 43015",
    email: null,
    website: null,
    rating: 4.4,
    reviewCount: 46,
    ...
    coverVariant: "basket",
    imageUrl: null,
    upiId: "papertrail@upi",
    openingHours: "Mon - Sat, 9:00 AM - 8:00 PM",
    galleryUrls: ["/mockup/im-stationery.jpg", "/mockup/im-gifts.jpg"],
    isVerified: false,
    tags: ["gifts-stationery", "stationery", "gifts"],
    isFeatured: false,
    isPopular: false,
  },
];
...
function upsertSeedData(db: DatabaseSync) {
  ...
  for (const slug of retiredCategorySlugs) {
    db.prepare("UPDATE categories SET is_active = 0 WHERE slug = ?").run(slug);
  }
...
export function getCategoriesData() {
  ...
  const rows = db
    .prepare(`
      ...
      WHERE slug NOT IN ('restaurant', 'clinic', 'bakery', 'mobile', 'doctor-booking')
