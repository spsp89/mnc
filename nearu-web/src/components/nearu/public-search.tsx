  ...
  return (
    <article data-motion="card" className="relative flex h-full flex-col overflow-hidden rounded-[14px] border border-[#dfe6f2] bg-white shadow-[0_12px_25px_rgba(11,47,116,0.06)]">
      ...
      <div className="relative h-[118px] bg-slate-100 sm:h-[140px]">
        ...
        <Link
          href={`/business-card/${encodeURIComponent(business.slug)}`}
          className="absolute right-2 top-2 z-10 grid h-7 w-7 place-items-center rounded-full bg-black/24 text-white transition hover:bg-black/38 sm:right-3 sm:top-3 sm:h-8 sm:w-8"
          aria-label={`Open ${business.name} business card`}
        >
