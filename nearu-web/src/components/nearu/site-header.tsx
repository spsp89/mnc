  ...
  return (
    <header className="border-b border-white/10 bg-[#061f55] text-white">
      <div className="mx-auto flex h-[60px] max-w-[1800px] items-center gap-3 px-4 md:h-[72px] md:gap-5 md:px-10">
        ...
        <Link
          href="/feed"
          className="relative grid h-10 w-10 place-items-center rounded-full border border-white/14 text-white transition hover:bg-white/10 md:h-11 md:w-11 lg:ml-0"
          aria-label="Open local updates"
        >
